...
import {mockCallApi} from '../fake-call-api';
import {entities as ENTITIES} from '../mockEntities';
import {HassContext} from '@hakit/core';
import fakeApi from '../fake-call-service';
import {ServiceArgs} from '../fake-call-service/types';
import {dailyForecast, hourlyForecast} from '../mockWeather';
...
function HassProvider({children}: HassProviderProps) {
          ...
          return setEntities({
            [target]: {
              ...
              attributes: {
                ...
                ...(serviceData || {}),
                brightness:
                  entities[target].state === 'on'
                    ? entities[target].attributes.brightness
                    : 0,
              },
              ...dates,
  ...
  const callApi = useCallback(async (endpoint: string): Promise<any> => {
